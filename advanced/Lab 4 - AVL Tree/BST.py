...
class BinarySearchTree:
    ...
    def traverse_tree(self, function, sub_root=None):
        if sub_root is None:
            sub_root = self._root
            function(sub_root)
        if sub_root.left_child:
            function(sub_root.left_child, sub_root)
            self.traverse_tree(function, sub_root.left_child)
        if sub_root.right_child:
            function(sub_root.right_child, sub_root)
            self.traverse_tree(function, sub_root.right_child)
        return
